...
def register_page():
    ...
    if reg_form.validate_on_submit():
        ...
        try:
            ...
            flash("This e-mail was already registered. Please log in instead.")
            return redirect(url_for('login'))
        else:
            login_user(new_user)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user is None:
            flash("This e-mail is not registered, please register or enter the correct e-mail address.")
            return redirect(url_for('login'))
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if not current_user.is_anonymous:
            ...
            flash("Please log in to make your comment.")
            return redirect(url_for('login'))
